    ...
    return (
        ...
        >
            ...
            {showTooltip && (
                ...
                >
                    <div 
                        className="bg-white rounded-2xl shadow-2xl border border-stone-200/80 p-4 flex flex-col w-48 text-left animate-fadeIn relative"
                    ...
                    >
                        ...
                        <div className="relative z-20 space-y-3.5">
                            <div>
                                <div className="text-[10px] font-bold uppercase tracking-wider text-stone-400 mb-2">Geometry Type</div>
                            ...
                            <div>
                                <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-stone-400 mb-1">
                                    ...
                                    <span className="font-mono text-stone-600 text-xs">{(objectData.scale ?? 1).toFixed(1)}x</span>
                                </div>
                                <input 
                                    type="range" 
                                    min="0.4" 
                            ...
                            <div className="border-t border-stone-100 pt-2 flex items-center justify-between">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Remove</span>
                                <button 
